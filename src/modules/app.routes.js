const { insertStudetnsJSON } = require("../api/controllers/testController.js");
const { PERMISSIONS } = require("../api/helpers/constans.js");
const { isAuth } = require("../api/middlewares/isAuth.js");
const { checkPermission } = require("../api/middlewares/permission.guard.js");
...
const { ejsRouter } = require("../api/routes/ejsRouter.js");
