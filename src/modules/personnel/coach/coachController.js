...
const { copyObject, deleteInvalidPropertyInObject, deleteFileInPublic } = require("../../../api/helpers/function");
const { studentAndCoachSchema } = require("../../../api/validations/authSchema");
const { coachModel } = require("../../models/Personnel/coachModel");
const { validate_nationalId_clubId_coachId_beltId } = require("../../../api/helpers/validateFoundDB");
const { normalizeDataDates, normalizePhoneNumber } = require("../../../api/helpers/normalizeData");
const { generateToken } = require("../../../api/services/tokenServices");
const { isPassMatched } = require("../../../api/services/passwordServices");
